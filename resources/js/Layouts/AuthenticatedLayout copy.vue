...
const openOrCloseDropDown7Menu=()=>{dropDown7IsOpen.value=!dropDown7IsOpen.value};
...
<template>
    <div class="relative">
      <!--nav bar -->
    <div class="absolute z-10 w-full overflow-hidden bg-lime-700">
        <!-- navbar right -->
          <div class="flex justify-between px-4 sm:items-center">
            ...
            <div class="px-4 py-2 md:flex" :class="isOpen?'block':'hidden'">
              ...
              <div class="px-2 py-1 mt-1 font-semibold text-white rounded hover:bg-gray-600 md:p-0 md:mx-2">
               ...
               <div class="px-2 py-1 mt-1 font-semibold text-white rounded hover:bg-gray-600 hover:z-20 md:p-0 md:mx-2">
              ...
              <div class="px-2 py-1 mt-1 font-semibold text-white rounded hover:bg-gray-600 md:p-0 md:mx-2">
                ...
                <div class="flex-col py-2 space-y-1 md:flex" >
                   ...
                   :class="dropDown3IsOpen?'block':'hidden'"
                   >Users </Link>
                    <Link :href="route('packingVessel.index')" :active="route().current('packingVessel.index')"
                   class="px-3 py-1 mt-1 font-semibold text-white rounded hover:bg-gray-100 md:p-0 md:mx-2 "
                   :class="dropDown3IsOpen?'block':'hidden'"
                   >Packing Vessel </Link>
    ...
    <!--end of nav bar -->
        ...
        <div class="min-h-screen pt-16 overflow-hidden bg-gray-100">
