...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Scan</h2>
        </template>
                        ...
                        <!-- <div class=" md:grid md:grid-cols-3 md:space-x-1 w-full items-center justify-between md:gap-1  sm:space-y-2 md:flex-row"> -->
                           ...
                           <div class="grid md:grid-cols-3 sm:grid-cols-1">
                            <div class="flex flex-col items-center justify-center w-full col-span-1">
                                ...
                                <div class=" flex-1 tracking-wide strong">Scan Your Order!</div>
                             ...
                             <div v-if="scannedOrder.length!=0" class="col-span-1 p-5 m-3 shadow-sm border-2 rounded-md border-solid border-teal-400">
                                <div class="text-center tracking-wide font-bold uppercase p-1">Item Analysis</div>
                                <table class="">
                                    <thead>
                                        <tr>
                                            <th class=""></th>
                                            <th class="border-2 p-1 text-center">Part A</th>
                                            <th class="border-2 p-1 text-center">Part B</th>
                                            <th class="border-2 p-1 text-center">Part C</th>
                                            <th class="border-2 p-1 text-center">Part D</th>
                                            <th class="border-2 p-1 text-center">Total</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <th class="border-2 p-1 text-center">Ordered</th>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">16</td>
                                        </tr>

                                        <tr>
                                            <th class="border-2 p-1 text-center">Executed</th>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">4</td>
                                            <td class="border-2 p-1 text-center">4</td>
                                        ...
                                        <tr class="bg-teal-400 text white">
                                            <th class="border-2 p-1 text-center bg-white text-black">Pending</th>
                                            <td class="border-2 p-1 text-center">0</td>
                                            <td class="border-2 p-1 text-center">0</td>
                                            <td class="border-2 p-1 text-center">0</td>
                                            <td class="border-2 p-1 text-center">0</td>
                                            <td class="border-2 p-1 text-center">0</td>
                            ...
                            <div v-if="scannedOrder.length!=0" class="flex flex-col items-center justify-center w-full col-span-1 gap-y-2 ">
                                <Link :href="route('order.confirm',scannedOrder.No)">
                                    <Button
                               ...
                               <Link :href="route('order.parts',scannedOrder.No)">
                                <Button>
                                  Pick & Pack
                               </Button>
                               </Link>
