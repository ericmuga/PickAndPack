...
<template>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                            ...
                            <Toolbar>
                                ...
                                <div class="col-span-2">
                                  <form @submit.prevent="refreshSearch()">
                                    ...
                                    <div class=" rounded-lg grid sm:grid-cols-1 md:grid-cols-3">
                                     <div class="col-span-2">
                                       ...
                                       <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                                                ...
                                                <tbody>
                                                    ...
                                                    <td class="p-1 px-3 py-2 text-xs text-center flex-col " v-if="order.part_a!=0">
                                                       ...
                                                       <span class="p-2 m-1 rounded-full text-teal-500" 
                                                    ...
                                                    <td class="p-1 px-3 py-2 text-xs text-center " v-if="order.part_d!=0">
                                                        ...
                                                        <Button  v-show="order.confirm_d" icon="pi pi-eye" :badge=order.part_d severity="warning" text raised rounded aria-label="Notification" @click="showLines(order.order_no,'D')"/>
                                                         ...
                                                         <span class="p-1 m-4 rounded-full text-teal-500" 
                       ...
                       <div class="col-span-1 ml-16 p-1 ">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                            <thead class="">
   ...
   <Modal :show="showModal" @close="showModal=false" >
     ...
     <div class="flex flex-col p-4 rounded-sm">
        ...
        <div  class="w-full p-2 mb-2 tracking-wide text-center items-center text-white rounded-sm bg-slate-500"> Order Part</div>
