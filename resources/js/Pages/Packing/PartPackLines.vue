...
//   const blob = dataURItoBlob(pdfDataUri);
  ...
  formData.append('order',convertToValidFilename(props.orderLines.data[0].order.order_no+props.orderLines.data[0].part+'-'+props.orderLines.data[0].order.shp_name+'-'+index));
