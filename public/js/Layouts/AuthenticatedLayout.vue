        ...
        <div @click="toggleSubMenu('user')" class="px-4 py-2 cursor-pointer">
          ...
          <span v-else class="ml-2 text-white">&#9654;</span>
            ...
            <div v-show="subMenuOpen['user']">
                ...
                <!-- <div class="py-2 pl-8 cursor-pointer"> <a :href="route('logout')" method="post" as="button" class="block px-2 py-1 font-semibold text-white rounded hover:bg-gray-600 ">Log Out</a></div> -->
              <div class="py-2 pl-8 cursor-pointer">
   <div class="py-2 pl-8 cursor-pointer">
    <form id="logoutForm" action="{{ route('logout') }}" method="POST">
        @csrf
        <button type="button" onclick="document.getElementById('logoutForm').submit();" class="block px-2 py-1 font-semibold text-white rounded hover:bg-gray-600 focus:outline-none">
            Log Out
        </button>
    </form>
</div>
